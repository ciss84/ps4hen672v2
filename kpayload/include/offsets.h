...
#define ssc_sceKernelIsAssistMode       0x00189630

// enable debug option
#define enable_psvr_patch               0x00DDDD50
#define enable_patch1                   0x00DDD950
#define enable_patch2                   0x00DDDA50
#define enable_patch3                   0x00DDDC50
#define enable_patch4                   0x00DDDE50
#define enable_patch5                   0x00DDDF50

#define sceSblACMgrIsAllowedSystemLevelDebugging1  0x001B4410
#define sceSblACMgrIsAllowedSystemLevelDebugging2  0x001B4B90
#define sceSblACMgrIsAllowedSystemLevelDebugging3  0x001B4BB0

// Enable rwx mapping
#define sys_rwx_map                     0x002507F5 
#define sys_rwx_map1                    0x00250803
...
#define setloginpatch                   0x0001352C

// patch sys_setuid
#define sys_setuid                      0x0010BED0

// ptrace patches
#define ptrace_patches                  0x0010F892

// Patch copyinstr
#define copyinstr_patches               0x003C1CA3
// second copyinstr patch  
#define copyinstr2_patches              0x003C1CAF
// copyin
#define copyin_patches                  0x003C17F7
// second copyin patch  
#define copyin2_patches                 0x003C1803	
// copyout
#define copyout_patches                 0x003C1702
// second copyout patch  
#define copyout2_patches                0x003C170E

// Verbose Panics
#define Panic                           0x002ED33A

// Map-Self
#define map_self1                       0x00233C40
#define map_self2                       0x00233C50
#define map_self3                       0x000AD2E4

#define memcpy_stack                    0x003C15BD
#endif